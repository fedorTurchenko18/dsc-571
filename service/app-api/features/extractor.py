...
class FeatureExtractor:
    ...
    def transform(self):
        ...
        if self.return_target:
            ...
            for d in self.customer_level_features[self.generation_type]:
                if d['values'] == 'target':
                    self.customer_level_features[self.generation_type].remove(d)
    ...
    def extract_topic_modelling_features(self):
        ...
        if unique_categories.shape[0] > 0:
            ...
            self.sales['prodcatbroad'] = self.sales['prodcategoryname']
        return self.sales
